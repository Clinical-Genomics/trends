...
from vogue.commands.load.sample_analysis_summary import sample_analysis_summary as sample_analysis_summary_command
...
load.add_command(sample_analysis_summary_command)
